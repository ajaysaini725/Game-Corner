...
public class Solver {
	...
	//tests the solver function of this class
	public static void main(String [] args){
		PieceHolder p = new PieceHolder();
		p.fillWithDefaultPieces();
		
		Solver solver = new Solver(p.getPieces());

		solver.solve();
		PieceHolder solution = new PieceHolder(solver.getSolution());
