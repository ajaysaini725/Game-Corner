...
public class Piece{
	...
	//tests methods in the Piece class
	public static void main(String [] args){
		...
		Piece p2 = new Piece(-3, 2, 3, 4);
		System.out.println(p.fits(p2, Side.top));
		System.out.println(p.fits(p2, Side.left));
		
		Piece p3 = new Piece (1, -4, 3, 4);
		System.out.println(p.fits(p2, Side.top, p3, Side.right));
		System.out.println(p.fits(p2, Side.top, p3, Side.left));
		
		Piece p4 = new Piece(1, -2, -1, -4);
		System.out.println(p.fits(p2, Side.top, p3, Side.right, p4, Side.bottom));
		System.out.println(p.fits(p2, Side.top, p3, Side.right, p4, Side.left));
		
		Piece p5 = new Piece(1, 4, 2, -2);
		System.out.println(p.fits(p2, Side.top, p3, Side.right, p4, Side.bottom,
				p5, Side.left));
		System.out.println(p.fits(p2, Side.top, p3, Side.right, p4, Side.bottom,
				p5, Side.bottom));
